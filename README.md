...
I'm a Biotechnologits, DevOps Engineer, and Technical Writer. I'm passionate about sharing knowledge, documentation, observability, headless commerce, and others. I create technical content (on my [Blog](https://celyn.hashnode.dev/), [Newsletter](https://celyn.hashnode.dev/newsletter), and [YouTube](#), build useful [open-source projects](https://github.com/CyGold), build technical communities...

**Here's a quick summary about me**:

- 😊 Pronouns: She/her
- 💡 Fun fact: Currently settling into the observability space.
